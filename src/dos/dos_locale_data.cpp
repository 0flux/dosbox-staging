...
// - https://github.com/FDOS/cpi/blob/master/CPIKOI/codepage.txt
// - https://github.com/FDOS/cpi/blob/master/CPIMAC/codepage.txt
// - https://github.com/FDOS/cpi/blob/master/CPIWIN/codepage.txt
...
const std::vector<KeyboardLayoutInfoEntry> LocaleData::KeyboardLayoutInfo = {
	...
	},
	{
		...
		58210, // 60258 replaces ASCII 'I' with other symbol
		KeyboardScript::LatinQwerty,
		{
	...
	},
	{
		...
		869, // chosen because it supports EUR currency
		KeyboardScript::LatinQwerty,
		{
	...
	{
		{ "kk", "kk476" }, "Kazakh (QWERTY/national)",
		58152,
		KeyboardScript::LatinQwerty,
		{
	...
	},
	{
		...
		855, // XXX avoid code page 855, it leaves no table drawig characters
		KeyboardScript::LatinQwertz,
		{
			{ 855, KeyboardScript::Cyrillic },
			{ 872, KeyboardScript::Cyrillic },
...
const std::map<DosCountry, CountryInfoEntry> LocaleData::CountryData = {
	// clang-format off
