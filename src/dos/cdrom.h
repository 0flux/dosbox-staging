...
private:
	virtual std::vector<int16_t> ReadAudio(uint32_t sector, uint32_t num_frames) = 0;
	...
	RWQueue<AudioFrame> queue        {220500};
...
private:
	...
	std::vector<int16_t> ReadAudio(uint32_t sector, uint32_t num_frames) override;
